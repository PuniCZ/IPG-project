...
{
    // Compile shaders
    vertexShader = compileShader(GL_VERTEX_SHADER, loadFile("lab02_01_osvetleni.vs").c_str());
    fragmentShader = compileShader(GL_FRAGMENT_SHADER, loadFile("lab02_01_osvetleni.fs").c_str());
...
void onKeyDown(SDLKey key, Uint16 /*mod*/)
{
    switch(key) {
        ...
        case SDLK_l : phong = !phong; redraw(); break;
